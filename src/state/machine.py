...
_TRANSITIONS: dict[EpisodeState, set[EpisodeState]] = {
    ...
    EpisodeState.SCRIPTING: {EpisodeState.SCRIPT_QA, EpisodeState.FAILED, EpisodeState.PAUSED, EpisodeState.CANCELLED},
    ...
    EpisodeState.STORYBOARDING: {EpisodeState.GENERATING_AUDIO, EpisodeState.FAILED, EpisodeState.PAUSED, EpisodeState.CANCELLED},
    EpisodeState.GENERATING_AUDIO: {EpisodeState.GENERATING_IMAGES, EpisodeState.FAILED, EpisodeState.PAUSED, EpisodeState.CANCELLED},
