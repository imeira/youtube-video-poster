...
_TRANSITIONS: dict[EpisodeState, set[EpisodeState]] = {
    ...
    EpisodeState.GENERATING_IMAGES: {EpisodeState.VISUAL_QA, EpisodeState.LOCAL_ANIMATION, EpisodeState.FAILED, EpisodeState.PAUSED, EpisodeState.CANCELLED},
    ...
    EpisodeState.LOCAL_ANIMATION: {EpisodeState.CLOUD_VIDEO_GENERATION, EpisodeState.ANIMATION_QA, EpisodeState.ASSEMBLING, EpisodeState.FAILED, EpisodeState.PAUSED, EpisodeState.CANCELLED},
