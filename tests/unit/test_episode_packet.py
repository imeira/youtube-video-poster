...
def complete_packet():
    return {
        ...
        "accuracy_report": {}, "safety_report": {}, "characters": [], "visual_bible": {},
        "chapters": [{"id": "C01"}],
        "narration_segments": [{"id": "N01", "chapter": "C01", "text": "Uma promessa.", "emotion": "esperança", "estimated_duration_s": 3.0, "reference": {"book": "Gênesis"}, "characters": [], "location": "tenda", "editorial_risk": "LOW", "visual_prompt": "warm scene", "transition": "cut", "suggested_sfx": []}],
        "scene_plan": [], "thumbnail_concepts": [], "title_candidates": [], "description": "Resumo", "tags": [], "production_notes": [], "estimated_word_count": 2, "estimated_duration_seconds": 184,
    }
